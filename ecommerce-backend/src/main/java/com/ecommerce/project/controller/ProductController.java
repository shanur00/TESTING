...
//  public ResponseEntity<ProductResponse> getProductsByUsersKeyword(@PathVariable String keyword,
//                                                                  @RequestParam(name = "pageNumber", defaultValue = AppConstants.PAGE_NUMBER) Integer pageNumber,
//                                                                  @RequestParam(name = "pageSize", defaultValue = AppConstants.PAGE_SIZE) Integer pageSize,
//                                                                  @RequestParam(name = "sortBy", defaultValue = AppConstants.SORT_PRODUCTS_BY) String sortBy,
//                                                                  @RequestParam(name = "sortOrder", defaultValue = AppConstants.SORT_ORDER) String sortOrder){
//    Users user = authUtil.loggedInUser();
//    ProductResponse productResponse = productService.searchProductByUsersKeyword(user,keyword, pageNumber, pageSize, sortBy, sortOrder);
//    return new ResponseEntity<>(productResponse, HttpStatus.FOUND);
//  }
